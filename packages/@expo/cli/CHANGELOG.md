...
- Expose tools the running app registers through `modelContext` from `expo/devtools` over the MCP server as `app_list_tools` and `app_call_tool`. ([#PR_MCP](https://github.com/expo/expo/pull/PR_MCP) by [@kudo](https://github.com/kudo))
