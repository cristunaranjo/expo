...
- Reload production env files and clear cached transforms when `run:ios --unstable-rebundle` replaces an embedded JavaScript bundle. ([#49511](https://github.com/expo/expo/pull/49511) by [@ramonclaudio](https://github.com/ramonclaudio))
